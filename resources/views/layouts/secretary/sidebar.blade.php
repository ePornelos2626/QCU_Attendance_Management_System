                ...
                <div class="slimscroll-menu" id="remove-scroll">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li class="">
                                <a href="{{ route('announcement_sec.show') }}" class="waves-effect {{ request()->is("schedule") || request()->is("schedule/*") ? "mm active" : "" }}">
                                    <i class="ti-announcement"></i> <span> Announcement </span>
                                </a>
                            </li>

                            <li class="">
                                <a href="{{ route('notification_blade_sec.show') }}" class="waves-effect {{ request()->is("schedule") || request()->is("schedule/*") ? "mm active" : "" }}">
                            ...
                            <li class="">
                                <a href="{{ route('faculty_blade_sec.show') }}" class="waves-effect {{ request()->is("schedule") || request()->is("schedule/*") ? "mm active" : "" }}">
                                    <i class="ti-user"></i> <span> Faculty </span>
                                </a>
                            </li>
